...
exports.useNetworkStatusContext = exports.NetworkStatusProvider = void 0;
const react_1 = __importStar(require("react"));
const useOfflineQueue_1 = require("../hooks/useOfflineQueue");
const NetworkStatusContext = (0, react_1.createContext)({
    isOnline: true,
    lastOnline: null,
});
...
exports.NetworkStatusProvider = NetworkStatusProvider;
const useNetworkStatusContext = () => {
    const context = (0, react_1.useContext)(NetworkStatusContext);
    if (!context) {
        throw new Error('useNetworkStatusContext must be used within NetworkStatusProvider');
    }
    return context;
};
exports.useNetworkStatusContext = useNetworkStatusContext;
