...
exports.LocalSqliteRepositoryModule = void 0;
...
const entities = [
    user_entity_1.UserEntity, order_entity_1.OrderEntity, session_entity_1.SessionEntity, audit_log_entity_1.AuditLogEntity,
    restaurant_entity_1.RestaurantEntity, restaurant_branch_entity_1.RestaurantBranchEntity, restaurant_gst_entity_1.RestaurantGSTEntity,
    menu_category_entity_1.MenuCategoryEntity, menu_item_entity_1.MenuItemEntity, hsn_sac_entity_1.HSNSACEntity, inventory_item_entity_1.InventoryItemEntity,
    driver_entity_1.DriverEntity, wallet_entity_1.WalletEntity, wallet_transaction_entity_1.WalletTransactionEntity, address_entity_1.AddressEntity,
    menu_variant_entity_1.MenuVariantEntity, menu_addon_entity_1.MenuAddonEntity, order_item_entity_1.OrderItemEntity, subscription_entity_1.SubscriptionEntity,
    otp_entity_1.OtpEntity, device_fingerprint_entity_1.DeviceFingerprintEntity, recipe_entity_1.RecipeEntity, batch_entity_1.BatchEntity,
    food_prep_entity_1.FoodPrepEntity, kitchen_sla_entity_1.KitchenSLAEntity, supplier_entity_1.SupplierEntity, inventory_alert_entity_1.InventoryAlertEntity,
    driver_assignment_entity_1.DriverAssignmentEntity, sla_alert_entity_1.SLAAlertEntity, menu_item_availability_entity_1.MenuItemAvailabilityEntity,
    driver_score_entity_1.DriverScoreEntity, delivery_sla_entity_1.DeliverySLAEntity, driver_fraud_entity_1.DriverFraudEntity, stripe_webhook_entity_1.StripeWebhookEntity,
    gst_detail_entity_1.GSTDetailEntity, payment_dispute_entity_1.PaymentDisputeEntity, idempotency_entity_1.IdempotencyEntity,
    payment_validation_entity_1.PaymentValidationEventEntity, payment_fraud_entity_1.PaymentFraudFlagEntity, payment_event_entity_1.PaymentEventEntity,
];
let LocalSqliteRepositoryModule = class LocalSqliteRepositoryModule {
};
exports.LocalSqliteRepositoryModule = LocalSqliteRepositoryModule;
exports.LocalSqliteRepositoryModule = LocalSqliteRepositoryModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        ...
        exports: [typeorm_1.TypeOrmModule, (0, mongoose_1.getModelToken)(review_schema_1.ReviewDocument.name)],
    })
