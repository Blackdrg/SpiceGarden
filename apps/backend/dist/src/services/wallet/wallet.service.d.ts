...
export declare class WalletService {
    ...
    constructor(walletRepo: Repository<WalletEntity>, walletTransactionRepo: Repository<WalletTransactionEntity>, configService: ConfigService, dataSource: DataSource, paymentService: PaymentService, notificationService: NotificationService);
