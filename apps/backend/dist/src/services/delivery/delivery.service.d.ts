...
export declare class DeliveryService {
    ...
    findAvailableDrivers(lat: number, lng: number, radiusInKm?: number): unknown;
    assignOrderToDriver(orderId: string, driverId: string): unknown;
    ...
    updateActualDeliveryTime(assignmentId: string, actualTimeMinutes: number): unknown;
