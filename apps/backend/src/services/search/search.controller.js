...
let SearchController = (() => {
    ...
    var SearchController = class {
        ...
        static {
            ...
            _getTrending_decorators = [(0, common_1.Get)('trending')];
            _getRecommended_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Get)('recommended')];
            ...
            __esDecorate(this, null, _getTrending_decorators, { kind: "method", name: "getTrending", static: false, private: false, access: { has: obj => "getTrending" in obj, get: obj => obj.getTrending }, metadata: _metadata }, null, _instanceExtraInitializers);
