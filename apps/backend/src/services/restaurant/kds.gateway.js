...
let KdsGateway = (() => {
    ...
    var KdsGateway = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _server_decorators = [(0, websockets_1.WebSocketServer)()];
            _handleStatusUpdate_decorators = [(0, websockets_1.SubscribeMessage)('updatePrepStatus')];
            ...
            KdsGateway = _classThis = _classDescriptor.value;
