...
let OrderController = (() => {
    ...
    let _placeOrder_decorators;
    let _healthCheck_decorators;
    var OrderController = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _placeOrder_decorators = [(0, common_1.Post)()];
            _healthCheck_decorators = [(0, common_1.Get)('health')];
            __esDecorate(this, null, _placeOrder_decorators, { kind: "method", name: "placeOrder", static: false, private: false, access: { has: obj => "placeOrder" in obj, get: obj => obj.placeOrder }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        orderService = __runInitializers(this, _instanceExtraInitializers);
