...
let PaymentWebhookController = (() => {
    let _classDecorators = [(0, common_1.Controller)('payments/webhook')];
    ...
    var PaymentWebhookController = class {
        ...
        static {
            ...
            _getWebhookStats_decorators = [(0, common_1.Get)('stats')];
            ...
            __esDecorate(this, null, _getWebhookStats_decorators, { kind: "method", name: "getWebhookStats", static: false, private: false, access: { has: obj => "getWebhookStats" in obj, get: obj => obj.getWebhookStats }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            PaymentWebhookController = _classThis = _classDescriptor.value;
    ...
    return PaymentWebhookController = _classThis;
})();
