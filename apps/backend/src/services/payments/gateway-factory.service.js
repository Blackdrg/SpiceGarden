...
let PaymentGatewayFactory = (() => {
    ...
    var PaymentGatewayFactory = class {
        ...
        static {
            ...
            PaymentGatewayFactory = _classThis = _classDescriptor.value;
        ...
        logger = new common_1.Logger(PaymentGatewayFactory.name);
        stripeGateway;
        razorpayGateway;
        defaultGateway;
    ...
    return PaymentGatewayFactory = _classThis;
})();
