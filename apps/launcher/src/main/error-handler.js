...
class ErrorHandler {
    ...
    logsDir;
    constructor() {
        this.logsDir = path.join(electron_.app.getPath('userData'), 'launcher-logs');
    ...
    detectDockerMissing() {
        return {
            ...
            severity: 'fatal',
            resolution: 'Download and install Docker Desktop from https://desktop.docker.com/windows/main/amd/Docker%Desktop%Installer.exe'
        };
    }
