...
const Modal = ({ isOpen, onClose, title, children, size = 'md', showCloseButton = true, closeOnOverlay = true, }) => {
    ...
    return (react_1.default.createElement("dialog", { ref: dialogRef, tabIndex: 0, "aria-label": title || 'Dialog', style: {
            position: 'fixed',
            top: 0,
            left: 0,
            right: 0,
        ...
        }, onClick: closeOnOverlay ? onClose : undefined, onKeyDown: (e) => { if (e.key === 'Enter' || e.key === ' ') {
            e.preventDefault();
            onClose();
        } } },
...
const BottomSheet = ({ isOpen, onClose, title, children, showCloseButton = true, closeOnOverlay = true, }) => {
    ...
    if (!isOpen)
        return null;
    return (react_1.default.createElement("dialog", { ref: dialogRef, tabIndex: 0, "aria-label": title || 'Bottom sheet', style: {
            position: 'fixed',
            top: 0,
            left: 0,
            right: 0,
