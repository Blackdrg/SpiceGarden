...
const LocationIcon = ({ size = 24, color, strokeWidth = 2, className, ...props }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(lucide_react_1.MapPin, { size: size, color: iconColor, strokeWidth: strokeWidth, className: className, "aria-hidden": props['aria-label'] ? undefined : true, ...props }));
};
