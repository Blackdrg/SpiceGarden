...
export const generateCSSVariables = () => {
  ...
  setVar('--spicegarden-font-family', DESIGN_TOKENS.typography.fontFamily);
  setVar('--spicegarden-font-mono', DESIGN_TOKENS.typography.fontFamilyMono);
...
export const getCSSVariableValue = (varName: string, fallback: string): string => {
