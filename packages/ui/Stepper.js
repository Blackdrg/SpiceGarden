...
const Stepper = ({ value, onChange, min = 1, max = 99, step = 1, label, disabled = false, size = 'md', }) => {
    ...
    return (react_1.default.createElement("div", { style: { display: 'inline-flex', alignItems: 'center', gap: tokens_1.DESIGN_TOKENS.spacing[3] } },
        label && (react_1.default.createElement("label", { htmlFor: "stepper-value", style: {
                ...tokens_1.DESIGN_TOKENS.typography.bodySmall,
                color: tokens_1.DESIGN_TOKENS.colors.textPrimary,
            } }, label)),
        react_1.default.createElement("div", { id: "stepper-value", role: "group", "aria-label": label || 'Stepper', style: {
                display: 'inline-flex',
                alignItems: 'center',
            ...
            react_1.default.createElement("button", { type: "button", onClick: decrement, disabled: disabled || value <= min, "aria-label": "Decrease quantity", style: {
            ...
            react_1.default.createElement("button", { type: "button", onClick: increment, disabled: disabled || value >= max, "aria-label": "Increase quantity", style: {
                    width: config.btnWidth,
                    height: config.height,
                    border: 'none',
                    background: 'transparent',
