...
const ToastProvider = ({ children }) => {
    ...
    const contextValue = (0, react_1.useMemo)(() => ({ showToast, hideToast }), [showToast, hideToast]);
    return (react_1.default.createElement(ToastContext.Provider, { value: contextValue },
        ...
        react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement("div", { style: { flex: 1, minWidth: 0 } },
                ...
                toast.actionLabel && toast.onAction && (react_1.default.createElement("button", { type: "button", onClick: toast.onAction, style: {
            ...
            react_1.default.createElement("button", { type: "button", onClick: () => hideToast(toast.id), "aria-label": "Dismiss notification", style: {
                    border: 'none',
...
const InlineAlert = ({ type = 'info', message, onClose, }) => {
    return (react_1.default.createElement("div", { style: {
        ...
        onClose && (react_1.default.createElement("button", { type: "button", onClick: onClose, "aria-label": "Close alert", style: {
                border: 'none',
                background: 'transparent',
                color: tokens_1.DESIGN_TOKENS.colors.textTertiary,
                cursor: 'pointer',
